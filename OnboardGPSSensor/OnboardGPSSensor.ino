...
void loop()
{
  ...
  if (fix) {
    ...
    if (extended == 1) {
#ifdef DEBUG_ENABLE
      Serial.print("heading=");Serial.print(gps.GetCourseDeg());
      Serial.print(" sats=");Serial.println(gps.GetSats());
#endif
#ifdef JETI_ENABLE		
...
#ifdef DEBUG_ENABLE
        Serial.print("alti abs=");Serial.print(altiabs);
        Serial.print("alti rel=");Serial.println(altirel);
#endif
#ifdef JETI_ENABLE
    ...
    if (extended == 1) {
#ifdef DEBUG_ENABLE
        Serial.print("dist home=");Serial.print(distToHome);
        Serial.print("course to model=");Serial.println(courseToModel);
#endif		
#ifdef JETI_ENABLE
